...
<template>
    <section id="home" class="bg-amber-50 scroll-mt-20 py-16">
        <div class="mex-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col-reverse lg:flex-row items-center gap-10">
            <div class="text-center lg:text-text-left max-w-xl">
                <h1 class="text-4xl sm-text-5xl front-bold text-amber-950 leading-tight md-4">
                    Discover the bers Deals on Top Products
                </h1>
